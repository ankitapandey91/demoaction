 ...
 */
public class HindiOCRActionExecuter extends OCRMethods {

	


	private static final String NAME = "Hindi-OCR";
	...
	public void executeImpl(Action ruleAction, NodeRef actionedUponNodeRef) {
		...
		this.executeOCR(ruleAction, actionedUponNodeRef, NAME, "hin");
