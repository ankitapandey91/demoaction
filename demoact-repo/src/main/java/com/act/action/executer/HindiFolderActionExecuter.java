...
public class HindiFolderActionExecuter extends OCRMethods
{

	public static final String NAME = "HindiOcr-Folder";
	...
	public void iterateThroughChildren( Action ruleAction,ChildAssociationRef childAssocRef)
	{
	    ...
	    for (ChildAssociationRef childAssoc : children) 
	    {
	      ...
	      // Use childNodeRef here.
	       ...
	       executeOCR(ruleAction, childAssoc.getChildRef(), NAME, "hin");
